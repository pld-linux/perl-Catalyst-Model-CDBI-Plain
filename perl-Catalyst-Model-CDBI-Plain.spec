...
do używania z podanymi przez użytkownika klasami Class::DBI. Nie
ustawia niczego automatycznie ani nie tworzy relacji - pozostawia to
użytkownikowi. Ten moduł może być używany z istniejącymi klasami
Class::DBI, które w ten sposób mogą być używane z Catalystem, albo
